    ...
    axios({
      ...
      .then(function (response) {
        if (response.data.save == true) {
          AsyncStorage.setItem('vendor', JSON.stringify(response.data.newVendor));
          ...
          setVendorEmailError('A user with this Email Address Already Exists');
        } else {
