...
const SellerSignup = () => {
  ...
  axios.delete(`http://localhost:8888/deleteCustomer/${customerId}`)
    ...
    // setLoading(true); // Set loader to true when starting the signup process
    ...
    axios({
      ...
      .then(function (response) {
        setLoading(false); // Set loader to false when signup process is complete
    ...
    navigation.navigate('CustomerDrawer');
      ...
      .catch(function (response) {
        setLoading(false); // Set loader to false in case of an error
        console.log('Stop');
     ...
     Log in
            ...
            <TouchableOpacity
              ...
              <Text
                ...
                already have an account? <Text style={{ color: AppColors.primary }}>Signup</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </Animatable.View>
